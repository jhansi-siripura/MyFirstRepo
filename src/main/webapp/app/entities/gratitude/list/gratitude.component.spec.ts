...
describe('Component Tests', () => {
  describe('Gratitude Management Component', () => {
    let comp: GratitudeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GratitudeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.gratitudes?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
