...
import { GratitudeTodayComponent } from './list/gratitude-today.component';
...
@NgModule({
  ...
  declarations: [
    GratitudeComponent,
    GratitudeDetailComponent,
    GratitudeUpdateComponent,
    GratitudeDeleteDialogComponent,
    GratitudeTodayComponent,
  ],
